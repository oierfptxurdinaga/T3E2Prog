...
/**
 * Klasifikazioa klasea talde bakoitzaren sailkapena kudeatzen du.
 * <p>
 * Taldearen emaitzak gordetzen ditu eta eguneraketa, ordenaketa eta lortutako datuak eskuratzeko
...
public class Klasifikazioa implements Serializable {
    ...
    /**
     * Talde bakoitzaren klasifikazioa gordetzeko mapa.
     * <p>
     * Teklade maparen gakoak Taldeak objektuak dira eta balioak TaldearenKlasifikazioa objektuak.
     * </p>
     */
    private static Map<Taldeak, TaldearenKlasifikazioa> klasifikazioaMap = new HashMap<>();

    /**
     * Static blokea, hasierako klasifikazioa berrabiarazteko.
     */
    static {
        berrabiarazi();
    }
    ...
    /**
     * Klasifikazioa berrabiarazten du: mapa garbitu eta talde guztiak berriro gehitu.
     */
    ...
    /**
     * Klasifikazioa hasieratzen du denboraldi bateko partiduetatik.
     * 
     * @param denboraldia Denboraldiaren izena edo identifikatzailea
     */
    ...
    /**
     * Klasifikazioa eguneratzen du partidu batekin.
     * 
     * @param partidua Partidua, jokatu izan behar da
     */
    ...
    /**
     * Ordenatutako klasifikazioa itzultzen du.
     * <p>
     * Ordena hauek kontuan hartuta:
     * <ul>
     * <li>Lehen puntuak</li>
     * <li>Ondoren seten diferentzia</li>
     * <li>Azkenik set irabaziak</li>
     * </ul>
     * </p>
     * 
     * @return TaldearenKlasifikazioa objektuen zerrenda ordenatua
     */
    ...
    /**
     * Talde zehatz baten klasifikazioa itzultzen du.
     * 
     * @param taldea Klasifikazioa nahi den taldea
     * @return TaldearenKlasifikazioa objektua edo null, taldea ez badago
     */
    ...
    /**
     * Egiaztatzen du klasifikazioa hutsik dagoen.
     * 
     * @return true hutsik badago, bestela false
     */
